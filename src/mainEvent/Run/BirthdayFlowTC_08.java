...
public class BirthdayFlowTC_08 extends baseClass {
	...
	{
		logger = extentReport.startTest("BirthdayFlowTC_08 : ADD on validations and TAX validations in PARTY ORDER SUMMARY page ");
