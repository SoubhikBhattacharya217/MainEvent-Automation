...
public class BowlingFlowTC_07 extends baseClass {
	...
	{
		logger = extentReport.startTest("BowlingPageFlowTC_07 : Validate the user given details and change buttons in ORDER SUMMARY PAGE ");
	...
	{
		OrderSummaryValidations.verify_details_on_ordersummary_page(driver, logger);
		OrderSummaryValidations.verify_change_button_validations(driver, logger);
	}
