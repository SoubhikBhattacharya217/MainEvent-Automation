...
public class BirthdayFlowTC_09 extends baseClass {
	...
	{
		logger = extentReport.startTest("BirthdayFlowTC_09 : CART page validations ");
	...
	public void  verifySearchLocationPage() throws Exception
	{
	 ...
	 {
		 CartPageModifyValidation.verify_modify_and_delete_bttn(driver, logger); 
	 }
	@AfterMethod
