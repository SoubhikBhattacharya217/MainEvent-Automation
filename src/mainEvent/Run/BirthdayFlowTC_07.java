...
public class BirthdayFlowTC_07 extends baseClass {
	...
	{
		logger = extentReport.startTest("BirthdayFlowTC_07 : Verify (GO TO CART , CONTINUE SHOPPING) button validation , Complete information details validations and all Change button validations in the PARTY ORDER SUMMARY page ");
	...
	public void  verifySearchLocationPage() throws Exception
	{
	 ...
	 public void party_order_summary_validations() throws Exception
	 {
		 ...
		 PartyOrderSummaryValidations.party_order_summary(driver, logger);
