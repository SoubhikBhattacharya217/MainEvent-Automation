...
public class BirthdayFlowTC_03 extends baseClass {
	...
	{
		logger = extentReport.startTest("BirthdayFlowTC_03 : Select Package page validations");
	...
	public void  verifySearchLocationPage() throws Exception
	{
	  ...
	  public void verifySelectPackagePage() throws Exception
	 {
		 ...
		 selectPackagePageValidations.verify_select_package_page(driver, logger);
