...
public class BirthdayFlowTC_06 extends baseClass {
	...
	{
		logger = extentReport.startTest("BirthdayFlowTC_06 : Verify multiple functionalities in the SELECT YOU PARTY TIME pop up ");
