...
public class BowlingFlowTC_05 extends baseClass {
	...
	{
		logger = extentReport.startTest("BowlingPageFlowTC_05 : Validate Successfull selection of time slot from Slect Your Bowling Time Pop Up  ");
