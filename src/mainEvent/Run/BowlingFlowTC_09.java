...
public class BowlingFlowTC_09 extends baseClass{
	...
	{
		logger = extentReport.startTest("BowlingPageFlowTC_09 : Validate Terms And Conditions checkbox and GO TO CART button in ORDER SUMMARY PAGE ");
	...
	{
		OrderSummaryValidations.verify_terms_and_conditions(driver, logger);
	}
