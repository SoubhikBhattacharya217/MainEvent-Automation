...
public class BowlingFlowTC_08 extends baseClass {
	...
	{
		logger = extentReport.startTest("BowlingPageFlowTC_08 : Validate Add On Presence and TAX validations after adding ADD Ons in ORDER SUMMARY PAGE ");
	...
	{
		OrderSummaryValidations.verify_add_ons__validations(driver, logger);
		OrderSummaryValidations.verify_add_ons__addition_and_total_amount(driver, logger);
	}
