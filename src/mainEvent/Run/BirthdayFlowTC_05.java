...
public class BirthdayFlowTC_05 extends baseClass {
	...
	{
		logger = extentReport.startTest("BirthdayFlowTC_05 : Validation of different functionalities of the Configure package Page. ");
